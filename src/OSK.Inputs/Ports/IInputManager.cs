...
public interface IInputManager
{
    ...
    Task<IOutput> ResetUserActiveInputSchemeAsync(int userId, string inputDefinitionId, string controllerName, CancellationToken cancellationToken = default);
    Task<IOutput<ActiveInputScheme>> SetActiveInputSchemeAsync(int userId, string inputDefinitionId, string controllerName, string schemeId,
    ...
    Task<IOutput> DeleteCustomInputSchemeAsync(string inputDefinitionName, string controllerName, string schemeName,
        CancellationToken cancellationToken = default);
