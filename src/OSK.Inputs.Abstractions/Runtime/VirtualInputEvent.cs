...
/// which comes from a <see cref="DeviceInput"/>. The virtual inputs are managed by the software and are triggered on behalf
/// of the user.
/// </summary>
...
public class VirtualInputEvent(VirtualInput virtualInput, InputPhase phase)
    : InputEvent(phase)
{
    public VirtualInput VirtualInput => virtualInput;
}
