...
/// <summary>
/// Represents a pointer, <see cref="InputType.Pointer"/>, event on a device. This could be a touch, mouse, or similar event.
/// </summary>
...
public class InputPointerEvent(RuntimeDeviceIdentifier device, PhysicalInput input, InputPhase phase,
