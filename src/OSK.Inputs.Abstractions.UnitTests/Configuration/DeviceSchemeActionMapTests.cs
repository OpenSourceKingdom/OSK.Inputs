...
public class DeviceSchemeActionMapTests
{
    ...
    {
        // Arrange
        var combinationInput = new DeviceCombinationInput(InputDeviceType.Generic, new TestInput(1));
    ...
    {
        // Arrange
        var combinationInput = new DeviceCombinationInput(InputDeviceType.Generic, new TestInput(2), new TestInput(3));
