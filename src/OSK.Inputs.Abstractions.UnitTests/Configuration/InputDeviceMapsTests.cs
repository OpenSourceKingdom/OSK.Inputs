...
public class InputDeviceMapsTests
{
    ...
    {
        // Arrange
        var map = new InputDeviceMap() { DeviceIdentity = TestIdentity.Identity1, InputMaps = [] };
    ...
    {
        // Arrange
        var map = new InputDeviceMap() { DeviceIdentity = TestIdentity.Identity1, InputMaps = [ new InputMap() { ActionName = "abc", InputId = 123 }] };
