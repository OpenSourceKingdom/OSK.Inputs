...
public class InputDeviceMapsTests
{
    ...
    {
        // Arrange
        var map = new DeviceInputMap() { DeviceFamily = TestDeviceFamily.Identity1, InputMaps = [] };
    ...
    {
        // Arrange
        var map = new DeviceInputMap() { DeviceFamily = TestDeviceFamily.Identity1, InputMaps = [ new InputMap() { ActionName = "abc", InputId = 123 }] };
